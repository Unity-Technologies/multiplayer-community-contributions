...
namespace Photon.Realtime.Editor
{
    ...
    public partial class WizardWindow
    {
        private class WizardText
        {
            ...
            internal static readonly string STEP_INTRO = "Wizard Intro";
            internal static readonly string STEP_HISTORY = "Release History";
            internal static readonly string STEP_PHOTON = "Photon Cloud";
            internal static readonly string STEP_SUPPORT = "Support";
